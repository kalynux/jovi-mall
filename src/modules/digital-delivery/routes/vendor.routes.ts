...
//
// SUPERSEDED. Vendor digital-asset management is already live per-variant via the
// catalog module at:
//   /api/vendor/products/:productId/variants/:variantId/digital/*
//   (see catalog/controllers/vendor-digital-asset.controller.ts + vendor-products.routes.ts)
//
// This older `createVendorDigitalRoutes` factory is imported/mounted nowhere and also
// carried the `req.user.vendorId` auth bug. Wiring it would create duplicate/conflicting
// endpoints. Left here (commented) for reference only.
// ─────────────────────────────────────────────────────────────────────────────
