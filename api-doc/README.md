...
### Agency
- [What changed on 2026-09-21: agents' COD pools are automatic](./agency/FRONTEND-CHANGELOG-cod-pool.md). Branch the COD refusal copy on the new `details.poolBinds`
...
### Agent
- **▶ [What changed on 2026-09-21: the COD pool comes from the plan](./agent/FRONTEND-CHANGELOG-cod-pool.md)**: automatic from your plan once verified; a new "carry less" control; plan cards show `max_cod_pool`; the emergency contact is now visible to platform staff
