...
**Verified against source on 2026-09-08** — `GET /api/agency/vendors` and the error catalogue, against `jovi-mall/src/modules/delivery/agency.routes.ts` and `src/core/error-codes.ts`.
