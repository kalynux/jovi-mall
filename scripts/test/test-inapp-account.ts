...
function main(): void {
    ...
    const PHRASES = {
        en: { tapToOpen: 'Tap to sign in on this device:', codeIntro: 'Or sign in with your phone number and this code:', codeOnly: 'Sign in with your phone number and this code:', website: 'Website:', validFor: 'Valid for:', singleUse: 'Single use only.', ignore: 'If you did not ask to sign in, ignore this message.' },
        fr: { tapToOpen: 'Touchez pour vous connecter sur cet appareil :', codeIntro: 'Ou connectez-vous avec votre numéro de téléphone et ce code :', codeOnly: 'Connectez-vous avec votre numéro de téléphone et ce code :', website: 'Site web :', validFor: 'Valable :', singleUse: 'Utilisable une seule fois.', ignore: "Si vous n'avez pas demandé à vous connecter, ignorez ce message." },
        pt: { tapToOpen: 'Toque para entrar neste dispositivo:', codeIntro: 'Ou entre com o seu número de telefone e este código:', codeOnly: 'Entre com o seu número de telefone e este código:', website: 'Site:', validFor: 'Válido:', singleUse: 'Utilizável apenas uma vez.', ignore: 'Se não pediu para entrar, ignore esta mensagem.' },
        es: { tapToOpen: 'Toca para iniciar sesión en este dispositivo:', codeIntro: 'O inicia sesión con tu número de teléfono y este código:', codeOnly: 'Inicia sesión con tu número de teléfono y este código:', website: 'Sitio web:', validFor: 'Válido:', singleUse: 'Se puede usar una sola vez.', ignore: 'Si no pediste iniciar sesión, ignora este mensaje.' },
        ar: { tapToOpen: 'اضغط لتسجيل الدخول على هذا الجهاز:', codeIntro: 'أو سجّل الدخول برقم هاتفك وهذا الرمز:', codeOnly: 'سجّل الدخول برقم هاتفك وهذا الرمز:', website: 'الموقع:', validFor: 'صالح لمدة:', singleUse: 'للاستخدام مرة واحدة فقط.', ignore: 'إن لم تطلب تسجيل الدخول، تجاهل هذه الرسالة.' },
    };
